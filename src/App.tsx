...
const mockProdutos: Produto[] = [
  { id: 'p1', nome: 'Baby Doll Rendado Rosê', desc: 'Baby doll delicado em microfibra com renda, confortável para o dia a dia.', cat: 'Baby doll', custo: 14, margem: 35, venda: 18.9, forn: 'f1', img: 'https://images.unsplash.com/photo-1617331721458-bd3bd3f9c7f8?w=600&h=800&fit=crop', imagens: ['https://images.unsplash.com/photo-1617331721458-bd3bd3f9c7f8?w=800&h=1000&fit=crop','https://images.unsplash.com/photo-1583496702414-c3372525c6ce?w=800&h=1000&fit=crop','https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=800&h=1000&fit=crop'], estoque: 32, novo: true, promo: false, tamanhos: ["P","M","G"] },
  { id: 'p2', nome: 'Blusa Básica Canelada', desc: 'Blusa canelada premium, toque macio e caimento perfeito.', cat: 'Blusas', custo: 12, margem: 54, venda: 18.5, forn: 'f1', img: 'https://images.unsplash.com/photo-1554568218-0f1715e72254?w=600&h=800&fit=crop', imagens: ['https://images.unsplash.com/photo-1554568218-0f1715e72254?w=800&h=1000&fit=crop','https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=800&h=1000&fit=crop'], estoque: 18, novo: true, promo: true, tamanhos: ["P","M","G","GG"] },
  { id: 'p3', nome: 'Camisola Longa Estampada', desc: 'Camisola longa em viscose leve com estampa floral exclusiva.', cat: 'Camisolas', custo: 22, margem: 40, venda: 30.8, forn: 'f2', img: 'https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=600&h=800&fit=crop', imagens: ['https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=800&h=1000&fit=crop'], estoque: 12, novo: true, promo: false, tamanhos: ["M","G","GG","G1"] },
  { id: 'p4', nome: 'Conjunto Feminino Amarelo', desc: 'Conjunto cropped + short, ideal para ficar em casa com estilo.', cat: 'Conjuntos feminino', custo: 28, margem: 45, venda: 40.6, forn: 'f2', img: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=600&h=800&fit=crop', imagens: ['https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=800&h=1000&fit=crop','https://images.unsplash.com/photo-1506629905607-d405b7a30db9?w=800&h=1000&fit=crop','https://images.unsplash.com/photo-1617331721458-bd3bd3f9c7f8?w=800&h=1000&fit=crop'], estoque: 24, novo: false, promo: true, tamanhos: ["P","M","G","GG","G1","G2"] },
  { id: 'p5', nome: 'Pijama Americano Xadrez', desc: 'Pijama americano 100% algodão, botão frontal e bolso.', cat: 'Pijama Americano', custo: 35, margem: 35, venda: 47.25, forn: 'f1', img: 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=600&h=800&fit=crop', imagens: ['https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=800&h=1000&fit=crop'], estoque: 9, novo: true, promo: false, tamanhos: ["M","G","GG"] },
  { id: 'p6', nome: 'Conjunto Fitness Top+Legging', desc: 'Fitness alta compressão com secagem rápida.', cat: 'Fitness', custo: 32, margem: 50, venda: 48, forn: 'f1', img: 'https://images.unsplash.com/photo-1506629905607-d405b7a30db9?w=600&h=800&fit=crop', imagens: ['https://images.unsplash.com/photo-1506629905607-d405b7a30db9?w=800&h=1000&fit=crop'], estoque: 15, novo: false, promo: false, tamanhos: ["P","M","G"] },
  { id: 'p7', nome: 'Camisola Infantil Unicórnio', desc: 'Camisola infantil fofa e confortável para as pequenas.', cat: 'Infantil feminino', custo: 10, margem: 85, venda: 18.5, forn: 'f2', img: 'https://images.unsplash.com/photo-1562157873-818bc0726f68?w=600&h=800&fit=crop', imagens: ['https://images.unsplash.com/photo-1562157873-818bc0726f68?w=800&h=1000&fit=crop','https://images.unsplash.com/photo-1583496702414-c3372525c6ce?w=800&h=1000&fit=crop'], estoque: 40, novo: true, promo: true, tamanhos: ["8","10","12","14","16"] },
  { id: 'p8', nome: 'Moletom Inverno Peluciado', desc: 'Moletom quentinho para o inverno, interior flanelado.', cat: 'Inverno', custo: 45, margem: 40, venda: 63, forn: 'f1', img: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=600&h=800&fit=crop', imagens: ['https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=600&h=800&fit=crop'], estoque: 7, novo: false, promo: false, tamanhos: ["G","GG","G1","G2"] },
];
