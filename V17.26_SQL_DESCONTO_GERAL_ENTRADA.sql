-- THITA Store V17.26
-- Permite desconto comercial da nota em qualquer forma de pagamento.
-- Mantém parcelamento, rascunho persistente e fechamento exato dos centavos.
-- Execute depois dos scripts V17.24 e V17.25.x.
...
begin
  ...
  update public.entradas set fornecedor_id=p_fornecedor_id,
    ...
    frete=coalesce(p_frete,0),desconto_nota=coalesce(p_desconto_nota,0),
